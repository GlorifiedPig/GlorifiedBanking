...
--[[ Addon Integrations ]]--
    GlorifiedBanking.Config.SUPPORT_ZEROS_ADDONS = true -- If you have any of Zero's addons on your server, you can choose for your income to go to your bank with this option.
