...
function PANEL:Init()
    ...
    self.Enter.DoClick = function(s)
        --Set self.Player's balance to self.Entry:GetValue()
        self:Remove()
    end
end
...
function PANEL:Paint(w, h)
    ...
    draw.SimpleText(i18n.GetPhrase("gbEnterBalance", self.Player and self.Player:Name() or "undefined"), "GlorifiedBanking.AdminMenu.SetBalanceDescription", w * .021, h * .23, self.Theme.Data.Colors.adminMenuNavbarItemCol)
end
