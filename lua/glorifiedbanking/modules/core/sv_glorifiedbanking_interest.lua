...
function GlorifiedBanking.ApplyPlayerInterest( ply )
    ...
    GlorifiedBanking.Notify( ply, NOTIFY_GENERIC, 5, GlorifiedBanking.i18n.GetPhrase( "gbInterestReceived", GlorifiedBanking.FormatMoney( interestAmount ) ) ) -- Notify the player that they have received their interest.
