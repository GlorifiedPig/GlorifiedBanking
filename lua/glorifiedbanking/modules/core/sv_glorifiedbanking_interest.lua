...
function GlorifiedBanking.ApplyPlayerInterest( ply )
    ...
    DarkRP.notify( ply, NOTIFY_GENERIC, 5, i18n.GetPhrase( "gbInterestReceived", GlorifiedBanking.FormatMoney( interestAmount ) ) ) -- Notify the player that they have received their interest.
